...
from expected_value import calc_ror, run, expected_value, get_mover_and_better, play_hand, simulate_hand
...
class TestPlayHand(unittest.TestCase):
    ...
    def test_h17(self):
        cfile = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data', 'h17', '6deck_h17_das_peek_basic_strategy.csv')
        action_class = BasicStrategyMover(cfile)
